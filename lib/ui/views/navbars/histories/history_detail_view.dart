...
import 'package:kantin_online/viewmodels/history_detail_view_model.dart';
...
class _HistoryDetailViewState extends State<HistoryDetailView> {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<HistoryDetailViewModel>.reactive(
    viewModelBuilder: () => HistoryDetailViewModel(),
